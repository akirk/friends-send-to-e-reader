...
require_once __DIR__ . '/includes/class-friends-send-to-e-reader.php';
require_once __DIR__ . '/includes/class-friends-e-reader.php';
...
add_action(
	...
	function( $friends ) {
		...
		require_once __DIR__ . '/includes/class-friends-e-reader-generic-email.php';
		$send_to_e_reader->register_ereader( 'Friends_E_Reader_Generic_Email' );

		require_once __DIR__ . '/includes/class-friends-e-reader-kindle.php';
		$send_to_e_reader->register_ereader( 'Friends_E_Reader_Kindle' );

		require_once __DIR__ . '/includes/class-friends-e-reader-pocketbook.php';
		$send_to_e_reader->register_ereader( 'Friends_E_Reader_Pocketbook' );

		require_once __DIR__ . '/includes/class-friends-e-reader-tolino.php';
		$send_to_e_reader->register_ereader( 'Friends_E_Reader_Tolino' );

		require_once __DIR__ . '/includes/class-friends-e-reader-download.php';
